...
//     // F*x_n_n
//     mul(KalmanFilter::F, KalmanFilter::x_n_n, FX_n_n, KalmanFilter::n_x, KalmanFilter::n_x, 1);

//     // G*u_n
//     mul(KalmanFilter::G, KalmanFilter::u_n, GU_n, KalmanFilter::n_x, KalmanFilter::n_x, 1);
